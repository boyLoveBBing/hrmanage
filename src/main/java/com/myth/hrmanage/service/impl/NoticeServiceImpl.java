...
import com.myth.hrmanage.entity.Notice;
import com.myth.hrmanage.dao.NoticeDao;
import com.myth.hrmanage.service.NoticeService;
...
public class NoticeServiceImpl implements NoticeService {
    ...
    public Integer count() {
        return Math.toIntExact(noticeDao.count(new Notice()));
    }
}
